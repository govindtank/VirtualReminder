...
public abstract class OnGestureListener implements View.OnTouchListener {
	...
	private void SingleFingerGesture(Pointer primePointer) {
		...
		if(primeDistanceX < 0-Pointer.DISTANCE_BENCHEMARK && primeDistanceY > Pointer.DISTANCE_BENCHEMARK){
			
			if(lastSwipeType == 2 && primePointer.endTime - lastSwipeTime < Pointer.TIME_BECHMARK){
				...
				lastSwipeTime = primePointer.endTime;
				lastSwipeType = 1;
				return;
			}
		}
		else if(primeDistanceX > Pointer.DISTANCE_BENCHEMARK && primeDistanceY > Pointer.DISTANCE_BENCHEMARK ){
			
			if(lastSwipeType == 1 && primePointer.endTime - lastSwipeTime < Pointer.TIME_BECHMARK){
	...
	public void oneFingerTop2Bottom(){System.out.println("oneFingerTop2Bottom");}
	
	public void oneFingerBottom2Top(){System.out.println("oneFingerBottom2Top");}
	
	public void oneFingerLeft2Right(){System.out.println("oneFingerLeft2Right");}
	
	public void oneFingerRight2Left(){System.out.println("oneFingerRight2Left");}
	
	public void oneFingerSingleClick(){System.out.println("oneFingerSingleClick");}
	
	public void oneFingerDoubleClick(){System.out.println("oneFingerDoubleClick");}
	
	public void oneFingerCross(){System.out.println("oneFingerCross");}
	
	public void oneFingerLongPress(){System.out.println("oneFingerLongPress");}
